...
from kruppe.prompts.rag import (
    STANDARD_SYSTEM,
    RAG_STANDARD_SYSTEM,
    RAG_STANDARD_USER,
)
...
class CustomPromptFormatter(BasePromptFormatter):
    def __init__(self, prompt_template: str, system_prompt: str = STANDARD_SYSTEM):
...
class SimplePromptFormatter(BasePromptFormatter):
    def __init__(self, system_prompt: str = STANDARD_SYSTEM):
        """
...
class RAGPromptFormatter(BasePromptFormatter):
    def __init__(
        self,
        system_prompt: str = RAG_STANDARD_SYSTEM,
        ...
        if prompt_template == "default":
            self.prompt_template = RAG_STANDARD_USER
        else:
